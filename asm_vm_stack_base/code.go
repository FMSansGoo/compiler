...
var definitions = map[OpCode]*Definition{
	...
	OpCodeAddEquals:         {OpCodeAddEquals.Name(), 0, 0},
	OpCodeSubEquals:         {OpCodeSubEquals.Name(), 0, 0},
	OpCodeMulEquals:         {OpCodeMulEquals.Name(), 0, 0},
	OpCodeDivEquals:         {OpCodeDivEquals.Name(), 0, 0},
